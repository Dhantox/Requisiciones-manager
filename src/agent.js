...
export const Requisiciones = {
  ...
  totalRequisiciones: () =>
    requests.get('requisiciones/requisiciones/total_requisiciones/'),
  totalCategorias: () =>
    requests.get('requisiciones/requisiciones/total_categorias/'),
  totalTipos: () => requests.get('requisiciones/requisiciones/total_tipos/')
};
